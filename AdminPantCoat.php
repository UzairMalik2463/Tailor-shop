...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($image) || empty($description)) {
        ...
        $sql = "INSERT INTO `pantcoat` (`description`, `image`) VALUES ('$description', '$image')";
...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark pant-coat-navbar  fixed-top" id="navbar">
            ...
            <div class="offcanvas sidebar offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li class="nav-item mx-2 fs-5">
                            <a class="nav-link active " href="AdminPantCoat.php">Pant Coat</a>
                        </li>
                        <li class="nav-item mx-2 fs-5">
    ...
    <form action="adminPantCoat.php" method="post" enctype="multipart/form-data">
...
<div class="mx-3">
<a class="nav-link " href="PantCoatRead.php">
